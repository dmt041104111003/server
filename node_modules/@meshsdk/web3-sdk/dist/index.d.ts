...
declare function clientDeriveWallet(encryptedKeyShard: string, spendingPassword: string, custodialShard: string, networkId: 0 | 1): Promise<_meshsdk_wallet.MeshWallet>;

declare function clientGenerateWallet(spendingPassword: string): Promise<{
    pubKeyHash: string;
...
declare function openWindow(url: string, params: {}, appUrl?: string): Promise<any>;
...
declare class WalletDeveloperControlled {
     ...
     */
    getWallet(walletId: string, networkId: 0 | 1): Promise<{
...
declare class Web3Wallet extends MeshWallet {
    ...
    static enable(options: InitWeb3WalletOptions): Promise<Web3Wallet>;
    /**
     ...
     */
    static initWallet({ networkId, address, fetcher, submitter, projectId, appUrl, }: {
        networkId: 0 | 1;
        address: string;
        fetcher?: IFetcher;
        submitter?: ISubmitter;
...
declare function getWalletFromWindow({ networkId, projectId, appUrl, }: WindowWalletReq): Promise<{
    success: false;
    error: {
        errorMessage?: string;
        errorCode?: number;
...
export { ApiError, type InitWeb3WalletOptions, type UserWalletSettings, type UserWalletSettingsWallet, type Web3Project, type Web3ProjectBranding, type Web3ProjectWallet, Web3Sdk, Web3Wallet, type WindowSignDataReq, type WindowSignDataRes, type WindowSignTxReq, type WindowSignTxRes, type WindowWalletReq, type WindowWalletRes, bytesToHex, bytesToString, clientDeriveWallet, clientGenerateWallet, combineShardsBuildWallet, crypto, decryptWithCipher, decryptWithPrivateKey, encryptWithCipher, encryptWithPublicKey, generateHash, generateKeyPair, getAddressFromHashes, getWalletFromWindow, hashData, hexToBytes, openWindow, shamirCombine, shamirSplit, spiltKeyIntoShards, stringToBytes };
